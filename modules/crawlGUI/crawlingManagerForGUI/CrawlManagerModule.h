...
class CrawlManagerModule : public RFModule, public crawlManagerService
{
   
    private:
    
    yarp::os::Port cmdPort; //the port used for exposing the service to the GUI (with thrift)
    ...
    // ******************************************
        ...
        // this function is necessary to expose the service with thrift
