...
/**
	* Computes the next state of the system based of the current one and of its
	* current parameters.
	* @param y current state vector to be updated (input and output)
	* @param at_states seemingly the joint next target joint angles (output)
	*/
